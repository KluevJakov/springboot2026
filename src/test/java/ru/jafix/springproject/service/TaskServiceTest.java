...
class TaskServiceTest extends CommonServiceTest {
    ...
    @Test
    void when_createTaskCorrectArg_should_returnCorrectAnswer() {
        ...
        when(taskRepository.save(fromMapper))
                .thenReturn(fromDb);
    ...
    @Test
    void when_editTaskCorrectArg_should_returnCorrectAnswer() {
    ...
    @Test
    void when_editTaskNullId_should_throwException() {
        TaskDto input = TaskDto.builder()
                .name(TASK_NAME)
                .owner(UserDto.builder()
                        .id(USER_UUID)
    ...
    @Test
    void when_editTaskNullName_should_throwException() {
        TaskDto input = TaskDto.builder()
                .id(TASK_UUID)
                .name(null)
                .owner(UserDto.builder()
    ...
    @Test
    void when_editTaskEmptyName_should_throwException() {
        TaskDto input = TaskDto.builder()
                .id(TASK_UUID)
                .name("")
                .owner(UserDto.builder()
